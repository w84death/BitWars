...
this.STATE='map';}
if(this.STATE=='map'&&state=='game'){ig.music.play('game');ig.music.volume=0.4;var params={};if(this.menu['map'].position===0){params.width=10;params.height=4;}
...
if((this.STATE=='game_over'&&state=='menu')||(this.STATE=='game_menu'&&state=='menu')){ig.music.play('menu');ig.music.volume=0.7;this.ai=null;this.unloadMap();this.STATE='menu';}},unloadMap:function(){for(var i=0;i<this.entities.length;i++){this.entities[i].kill();}
...
if(params.down){this.moveRow({row:this.ruler[this.team-1],down:true});}},moveCursor:function(params){this.sMenu.play();if(params.up){this.menu[this.STATE].position-=1;if(this.menu[this.STATE].position<0){this.menu[this.STATE].position=this.menu[this.STATE].cursor.length-1;}}
...
this.heroesImage.drawTile(this.GUI.centerTop.x-72,this.menu[this.STATE].cursor[this.menu[this.STATE].position]-12,1,30,28);this.heroesImage.drawTile(this.GUI.centerTop.x+42,this.menu[this.STATE].cursor[this.menu[this.STATE].position]-12,0,30,28);if(this.STATE=='menu'){this.spreadArmy.draw(this.GUI.centerBottom.x-40,this.GUI.centerBottom.y-70);}
