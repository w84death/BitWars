...
this.fontBlue.draw('BLUE SCORE - '+this.teams[0].score,this.GUI.leftTop.x,this.GUI.leftTop.y,ig.Font.ALIGN.LEFT);this.fontRed.draw(this.teams[1].score+' - RED SCORE',this.GUI.rightTop.x,this.GUI.rightTop.y,ig.Font.ALIGN.RIGHT);this.fontWhite.draw('SUMMER',this.GUI.centerTop.x,this.GUI.centerTop.y,ig.Font.ALIGN.CENTER);this.fontWhite.draw('TURN - '+this.turn,this.GUI.centerTop.x,this.GUI.centerTop.y+10,ig.Font.ALIGN.CENTER);if(this.team===1){this.fontBlue.draw('TEAM BLUE TURN',this.GUI.centerTop.x,this.GUI.centerTop.y+20,ig.Font.ALIGN.CENTER);}else{this.fontRed.draw('TEAM RED TURN',this.GUI.centerTop.x,this.GUI.centerTop.y+20,ig.Font.ALIGN.CENTER);}}
