...
if(params.down){this.menu.position+=1;if(this.menu.position>this.menu.cursor.length-1){this.menu.position=0;}}}},update:function(){this.parent();if(this.STATE=='intro'){if(ig.input.released('action')||ig.input.released('next_turn')){this.stateChange('menu');return;}}
...
if(ig.input.released('action')||ig.input.released('next_turn')){this.stateChange('newGame');return;}}
