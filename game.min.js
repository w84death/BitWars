...
this.status.moveing=true;},runToDo:function(){if(this.status.buying&&this.timer.delta()>-0.8){for(var i=0;i<this.toDo.buy.length;i++){for(var q=0;q<this.toDo.buy[i].quanity;q++){ig.game.buyUnit({unit:this.toDo.buy[i].unit,team:ig.game.team});};};this.status.buying=false;}
...
if(!this.status.moveing&&this.timer.delta()>0){this.status.thinking=false;}},unlock:function(){this.status.thinking=true;this.status.init=false;},think:function(){if(!this.status.init){this.timer.set(this.turnTime);this.toDo.buy=[];this.toDo.move=[];this.moveNo=0;this.lastMoveTime=-0.5;this.status.init=true;this.analizeTerrain();this.makeToDo();}
