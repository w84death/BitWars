...
this.team+=1;if(this.team>2){this.team=1;this.turn+=1;this.giveBTCtoPlayers();this.teams[0].moves+=1;this.teams[1].moves+=1;}},moveUnits:function(){var unit=false,unitsMoving=false,base=null,enemy=null,targetX;for(var x=0;x<this.map.blueprint.width;x++){for(var y=0;y<this.map.blueprint.height;y++){if(this.map.units[x][y]){unit=this.getEntityByName(this.map.units[x][y]);if(unit.turn==this.turn&&unit.team===this.team){if(!unit.flag){if(!unit.target){if(unit.team===1){targetX=x+1;}else{targetX=x-1;}
...
temp={};unit={};}},moveRuler:function(params){if(params.right){this.ruler[this.team-1]+=1;if(this.ruler[this.team-1]>this.map.blueprint.width-2){this.ruler[this.team-1]=1;}}
