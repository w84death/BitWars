...
MyGame = ig.Game.extend({
	...
	// ------------------------------------------------------------------------
						...
						version: 		'RC 4',
						messageUnderLogo: 'Celebrating 10.000 views !',
	...
	draw: function() {
		...
		if(this.STATE == 'tutorial'){
			...
			if(this.menu[this.STATE].page === 2){
				...
				this.fontWhite.draw('Tank is better than Soldier. Helicopter is better than Tank.', newX, newY+24, ig.Font.ALIGN.CENTER );
			}
			...
			if(this.menu[this.STATE].page === 5){
				...
				tutMessage2 = 'After each turn player earns +'+this.settings.btcPerTurn+' BTC and +'+this.settings.btcFromBase+' BTC for each\n'+
					'captured base on map. Collect CPUs to gain imediatly +'+this.settings.btcFromCpu+' BTC.\n'+
