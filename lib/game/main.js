...
MyGame = ig.Game.extend({
	...
	unitsSheet: 	new ig.Image( 'media/gfx/buy_buttons.png' ),
	...
	draw: function() {		
		...
		if(this.STATE == 'game'){
			...
			this.fontWhite.draw('[1]', newX-2, newY+3-24, ig.Font.ALIGN.RIGHT );		
			this.fontWhite.draw('[2]', newX-2, newY+3, ig.Font.ALIGN.RIGHT );		
			this.fontWhite.draw('[3]', newX-2, newY+3+24, ig.Font.ALIGN.RIGHT );

			this.fontWhite.draw('[spacebar]', this.GUI.centerBottom.x-22, this.GUI.centerBottom.y-8, ig.Font.ALIGN.RIGHT );		
		...
		if(this.STATE == 'game' || this.STATE == 'move' || this.STATE == 'terrain'){			
			...
			this.fontBlue.draw('MOVES - '+this.teams[0].moves, this.GUI.leftTop.x, this.GUI.leftTop.y+12, ig.Font.ALIGN.LEFT );		
			this.fontBlue.draw('BITCOINS - '+this.teams[0].bitcoins, this.GUI.leftTop.x, this.GUI.leftTop.y+24, ig.Font.ALIGN.LEFT );		
			
			this.fontRed.draw('RED SCORE - '+this.teams[1].score, this.GUI.rightTop.x, this.GUI.rightTop.y, ig.Font.ALIGN.RIGHT );		
			this.fontRed.draw(this.teams[0].moves+' - MOVES', this.GUI.rightTop.x, this.GUI.rightTop.y+12, ig.Font.ALIGN.RIGHT );		
			this.fontRed.draw(this.teams[0].bitcoins+' - BITCOINS', this.GUI.rightTop.x, this.GUI.rightTop.y+24, ig.Font.ALIGN.RIGHT );		
