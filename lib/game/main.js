	...
	draw: function() {		
		...
		if(this.STATE == 'tutorial'){
			...
			if(this.menu[this.STATE].page === 1){
				subTitle = 'Bit Wars is a turn based strategy game for two players.\n'+
			...
			if(this.menu[this.STATE].page === 2){
				subTitle = 'You have 3 unit types: Soldier, Tank and Helicopter.\n'+
			...
			this.fontWhite.draw(subTitle, this.GUI.centerTop.x, this.GUI.centerTop.y+24, ig.Font.ALIGN.CENTER );
