	...
	draw: function() {		
		...
		if(this.STATE == 'game' || this.STATE == 'move' || this.STATE == 'game_menu' || this.STATE == 'game_over'){			
			...
			if(this.STATE == 'game'){
				...
				this.fontWhite.draw('['+ this.GUI.labels._1 +']', newX+6, newY+9-22, ig.Font.ALIGN.CENTER );		
				this.fontWhite.draw('['+ this.GUI.labels._2 +']', newX+6, newY+9-4, ig.Font.ALIGN.CENTER );		
				this.fontWhite.draw('['+ this.GUI.labels._3 +']', newX+6, newY+9+14, ig.Font.ALIGN.CENTER );
				...
				this.fontWhite.draw('['+ this.GUI.labels.next +']', newX, newY+16, ig.Font.ALIGN.CENTER );										
