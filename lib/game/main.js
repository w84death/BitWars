...
MyGame = ig.Game.extend({
	...
	// ------------------------------------------------------------------------
						...
						version: 		'RC 4',
						messageUnderLogo: 'Celebrating 10.000 sessions !',
	...
	draw: function() {
		...
		if(this.STATE == 'intro'){
			...
			this.fontWhite.draw(this.messageUnderLogo, this.GUI.centerTop.x, this.GUI.centerTop.y+28, ig.Font.ALIGN.CENTER );
		...
		if(this.STATE == 'tutorial'){
			...
			if(this.menu[this.STATE].page === 1){
				tutMessage1 = 'Bit Wars is a turn based strategy game for two players.\n'+
					'Each turn player can move the terrain row up od down.\n'+
			...
			if(this.menu[this.STATE].page === 3){
				...
				tutMessage2 = 'Maps are made of tree types of terrain:\n'+
					'- flat land (grass) - forest (three) - mountains (rock)\n';
			}
