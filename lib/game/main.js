	...
	draw: function() {		
		...
		if(this.STATE == 'tutorial'){
			...
			if(this.menu[this.STATE].page === 1){
				paragraph = 'Bit Wars is a turn based strategy game for two players.\n'+
			...
			if(this.menu[this.STATE].page === 4){
				paragraph = 'Local multiplayer.\n'+
				'...\n'+
				'...\n';
			}

			this.fontWhite.draw(paragraph, this.GUI.centerMiddle.x, this.GUI.centerMiddle.y, ig.Font.ALIGN.CENTER );
